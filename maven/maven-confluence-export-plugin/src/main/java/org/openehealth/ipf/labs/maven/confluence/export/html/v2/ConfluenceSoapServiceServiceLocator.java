...
public class ConfluenceSoapServiceServiceLocator extends org.apache.axis.client.Service implements org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceSoapServiceService {
    ...
    public org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceSoapService getConfluenceserviceV2() throws javax.xml.rpc.ServiceException {
    ...
    public org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceSoapService getConfluenceserviceV2(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceserviceV2SoapBindingStub _stub = new org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceserviceV2SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceserviceV2SoapBindingStub _stub = new org.openehealth.ipf.labs.maven.confluence.export.html.v2.ConfluenceserviceV2SoapBindingStub(new java.net.URL(ConfluenceserviceV2_address), this);
                _stub.setPortName(getConfluenceserviceV2WSDDServiceName());
                return _stub;
            }
        }
