...
public class RemoteContentSummaries  implements java.io.Serializable {
    private org.openehealth.ipf.labs.maven.confluence.export.stubs.RemoteContentSummary[] content;
    ...
    public RemoteContentSummaries(
           org.openehealth.ipf.labs.maven.confluence.export.stubs.RemoteContentSummary[] content,
           int offset,
           int totalAvailable) {
     ...
     * @return content
     */
    public org.openehealth.ipf.labs.maven.confluence.export.stubs.RemoteContentSummary[] getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(org.openehealth.ipf.labs.maven.confluence.export.stubs.RemoteContentSummary[] content) {
        this.content = content;
    }
