...
import org.openehealth.ipf.labs.maven.confluence.export.service.ConfluenceSoapServiceService;
...
public class ConfluenceSoapServiceServiceLocator extends org.apache.axis.client.Service implements ConfluenceSoapServiceService {
    ...
    public ConfluenceSoapService getConfluenceserviceV1() throws javax.xml.rpc.ServiceException {
    ...
    public ConfluenceSoapService getConfluenceserviceV1(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ConfluenceserviceV1SoapBindingStub _stub = new ConfluenceserviceV1SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ConfluenceSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                ConfluenceserviceV1SoapBindingStub _stub = new ConfluenceserviceV1SoapBindingStub(new java.net.URL(ConfluenceserviceV1_address), this);
                _stub.setPortName(getConfluenceserviceV1WSDDServiceName());
                return _stub;
            }
        }
