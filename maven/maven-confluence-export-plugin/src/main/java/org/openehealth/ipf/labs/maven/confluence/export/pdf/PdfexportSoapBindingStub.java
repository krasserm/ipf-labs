...
public class PdfexportSoapBindingStub extends org.apache.axis.client.Stub implements org.openehealth.ipf.labs.maven.confluence.export.pdf.PdfExportRpc {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("https://developer.atlassian.com/rpc/soap-axis/pdfexport", "fault"),
                      "org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException",
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("https://developer.atlassian.com/rpc/soap-axis/pdfexport", "fault"),
                      "org.openehealth.ipf.labs.maven.confluence.export.pdf.AuthenticationFailedException",
    ...
    public PdfexportSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public PdfexportSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public PdfexportSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cls = org.openehealth.ipf.labs.maven.confluence.export.pdf.AlreadyExistsException.class;
            ...
            cachedSerQNames.add(qName);
            cls = org.openehealth.ipf.labs.maven.confluence.export.pdf.AuthenticationFailedException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.openehealth.ipf.labs.maven.confluence.export.pdf.InvalidSessionException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.openehealth.ipf.labs.maven.confluence.export.pdf.NotPermittedException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.openehealth.ipf.labs.maven.confluence.export.pdf.VersionMismatchException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public java.lang.String exportSpace(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException, org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://rpc.flyingpdf.extra.confluence.atlassian.com", "exportSpace"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException) {
              throw (org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException) axisFaultException.detail;
         }
   }
  throw axisFaultException;
    ...
    public java.lang.String login(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException, org.openehealth.ipf.labs.maven.confluence.export.pdf.AuthenticationFailedException, org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://rpc.confluence.atlassian.com", "login"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof org.openehealth.ipf.labs.maven.confluence.export.pdf.AuthenticationFailedException) {
              throw (org.openehealth.ipf.labs.maven.confluence.export.pdf.AuthenticationFailedException) axisFaultException.detail;
         }
        if (axisFaultException.detail instanceof org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException) {
              throw (org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException) axisFaultException.detail;
         }
  ...
  throw axisFaultException;
    ...
    public boolean logout(java.lang.String in0) throws java.rmi.RemoteException, org.openehealth.ipf.labs.maven.confluence.export.pdf.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://rpc.confluence.atlassian.com", "logout"));
