...
@ContextConfiguration(inheritLocations = false, locations = ['/camel-test-message.xml', '/camel-test-message-couch.xml'])
class MessageCouchTest extends MessageJpaTest {}
